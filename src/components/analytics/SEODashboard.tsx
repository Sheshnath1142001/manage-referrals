        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">
              {data.seo?.keywordRankings ? Object.keys(data.seo.keywordRankings).length : 0}
            </div>
            <p className="text-xs text-muted-foreground">
              Tracked keywords
            </p>
        ...
        <Card>
          ...
          <CardContent>
            <div className="space-y-4">
              {data.seo?.keywordRankings && Object.entries(data.seo.keywordRankings).map(([keyword, rankings]) => (
                <div key={keyword} className="flex items-center justify-between">
                  <div className="font-medium">{keyword}</div>
                  <div className="text-sm text-muted-foreground">
                    {Array.isArray(rankings) ? rankings.join(', ') : String(rankings)}
                  </div>
                </div>
              ))}
            </div>
